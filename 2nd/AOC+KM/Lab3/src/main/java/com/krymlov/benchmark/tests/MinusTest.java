...
public class MinusTest implements IOpTest{
    ...
    public long testChar(){
        ...
        long time = System.currentTimeMillis()+1000;
        while (System.currentTimeMillis() < time){
            if (number <= Character.MIN_VALUE+10){
